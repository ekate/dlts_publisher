         ...
         @books.each do |book|
           ...
           book_data={ :entity_title=>@mods_doc.get_title(@mods_doc_xml, @script)[0..254],
                       ...
                       :metadata=> { :title=>@drupal_doc.drupal_field("Title",@mods_doc.get_title(@mods_doc_xml, @script),"text_textfield","field_title"),
                                     ...
                                     :language=>@drupal_doc.drupal_field_array("Language",@mods_doc.get_language(@mods_doc_xml),"text_textfield","field_language"),
                                     :language_code=>@drupal_doc.drupal_field_array("Language",@mods_doc.get_language_code(@mods_doc_xml),"text_textfield","field_language_code"),
